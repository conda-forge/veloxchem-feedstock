...
cmake "${CMAKE_ARGS}" \
    ...
    -DMPI_CXX_SKIP_MPICXX:BOOL=ON || [ -f build/CMakeFiles/CMakeOutput.log ] && cat build/CMakeFiles/CMakeOutput.log; [ -f build/CMakeFiles/CMakeError.log ] && cat build/CMakeFiles/CMakeError.log
